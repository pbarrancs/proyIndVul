...
```
Nos damos cuenta que ingreso inferior, promedio años escolares, carencias de salud, carencias alimentos y personal médico están muy correlacionadas.

```{r}
omcdiag(df[-c(1,2,3,4,5,6,7,11,16)], df.1[2])
```

CLaramente pasa la prueba de no colonearidad; por lo que, nos quedamos con esperanza de vida, personas afiliadas a servicios, remuneracion, casos confirmados, desempleados, solicitudes de desempleados y carencias de servicios.
